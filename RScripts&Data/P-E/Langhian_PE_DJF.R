...
png(filename = "Langhian_P_DJF.png", width = 5000, height = 5000, res = 600)
...
png(filename = "Langhian_PE_DJF.png", width = 5000, height = 5000, res = 600)
